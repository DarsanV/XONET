      ...
      <div className="mx-auto w-full max-w-xl">
        <div className="relative">
          ...
          <Input
            ...
            className="h-10 rounded-md border-border bg-card pl-9 text-sm placeholder:text-muted-foreground/70 focus-visible:ring-1 focus-visible:ring-ring"
          />
        </div>
      </div>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            size="icon"
            className="h-10 w-10 rounded-full border border-border bg-card hover:bg-secondary"
          >
