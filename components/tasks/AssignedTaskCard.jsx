...
export function AssignedTaskCard({ task, freelancer, onView, onOpenChat, }) {
    ...
    const activityTime = task.lastActivityAt
        ...
        : "Recently";
    return (<Card className={cn("group border-border bg-card p-5 shadow-[0_1px_0_0_rgba(255,255,255,0.03)_inset]", "transition-all duration-300 hover:border-foreground/15 hover:shadow-[0_8px_30px_-12px_rgba(0,0,0,0.5)]")}>
