          ...
          <Card className="border-border bg-card">
            ...
            <CardContent className="space-y-3">
              <LinkField
                ...
                defaultValue="github.com/alexmercer"
              />
              <LinkField
                icon={Linkedin}
                placeholder="linkedin.com/in/alex"
                defaultValue="linkedin.com/in/alexmercer"
              />
              <LinkField
                icon={Globe}
                placeholder="portfolio.dev"
                defaultValue="alexmercer.dev"
              />
            </CardContent>
          </Card>
        </div>
          ...
          <div className="flex flex-wrap gap-2">
            {skills.map((s) => (
              <Badge
                key={s}
                variant="secondary"
                className="rounded-sm bg-secondary px-3 py-1 text-xs font-normal"
              >
                {s}
              </Badge>
            ))}
