...
export function ExploreView() {
    const { exploreTasks } = useTaskStore();
    const [query, setQuery] = useState("");
    const [category, setCategory] = useState("all");
    const [budget, setBudget] = useState("any");
    const openTasks = exploreTasks;
    ...
    return (<div className="space-y-8">
      <PageHeader eyebrow="Explore tasks" title="Find your next project" description="Browse open opportunities from other clients. Tasks you post appear under Tasks, not here."/>
