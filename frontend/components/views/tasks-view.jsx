    ...
    return (<div className="space-y-8">
      ...
      <section className="space-y-4 animate-in fade-in duration-300">
        ...
        {assignedTasks.length === 0 ? (<Card className="border-border bg-card py-12 text-center text-sm text-muted-foreground">
            ...
            {assignedTasks.map((task) => {
                ...
                if (!freelancer)
                    return null;
                return (<AssignedTaskCard key={task.id} task={task} freelancer={freelancer} onView={() => setDetailTask(task)} />);
            })}
          </div>)}
      </section>
      ...
      <Tabs value={mainTab} onValueChange={setMainTab} className="space-y-4">
        ...
        <TabsContent value="posted" className="space-y-4">
          <PostedTasksTable tasks={postedTasks} onView={setDetailTask} onEdit={setEditTask} onDelete={setDeleteId} onStatusChange={handleStatusChange} onPaymentChange={handlePaymentChange}/>
        </TabsContent>
      ...
      <TaskDetailSheet task={detailTask} open={!!detailTask} onOpenChange={(o) => !o && setDetailTask(null)} />
...
function PostedTasksTable({ tasks, onView, onEdit, onDelete, onStatusChange, onPaymentChange, }) {
    if (tasks.length === 0) {
