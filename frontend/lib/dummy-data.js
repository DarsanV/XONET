...
export const exploreJobs = [
    {
        ...
        description: "Looking for a senior front-end engineer to rebuild our marketing site with modern animation and a polished design system.",
        budget: "$3,800",
    ...
    },
    {
        ...
        description: "Build interactive dashboards with complex filters, exports, and role-based access for our B2B platform.",
        budget: "$7,200",
    ...
    },
    {
        ...
        description: "Migrate legacy Shopify storefront to Hydrogen with custom checkout extensions and improved Core Web Vitals.",
        budget: "$5,400",
    ...
    },
    {
        ...
        description: "Design and ship an internal tool for editors to draft, review, and publish AI-assisted long-form content.",
        budget: "$4,100",
    ...
    },
    {
        ...
        description: "Add multiplayer cursors, presence, and live document editing using Yjs and WebSockets.",
        budget: "$6,000",
    ...
    },
    {
        ...
        description: "Architect a multi-brand theming system across web and mobile with a shared token pipeline.",
        budget: "$3,500",
    ...
    experience: [
        {
            ...
            description: "Lead full-stack delivery for B2B analytics products. Own architecture, mentoring, and client-facing demos.",
        },
        {
            id: "exp-2",
            role: "Front-end Lead",
            company: "Layerframe",
            duration: "2020 — 2023",
            description: "Shipped design system and marketing site relaunch. Improved Core Web Vitals by 40%.",
        },
        {
            id: "exp-3",
            ...
            company: "Quill & Co.",
            duration: "2017 — 2020",
            description: "Built content workflows and subscription billing for a media SaaS platform.",
        },
    ],
    links: {
...
/** Logged-in user — owns posted tasks and must not see them in Explore */
export const CURRENT_USER_ID = "u1";
/** Default freelancer profile used when applying from Explore */
export const CURRENT_FREELANCER_ID = "f1";
/** Default client id for seeded tasks not posted by the current user */
export const DEFAULT_CLIENT_ID = "client-seed";
...
export const seedApplications = [
    {
        ...
        taskId: "task-seed-1",
        freelancerId: "f4",
        coverLetter: "I've led three marketing site redesigns with motion-heavy hero sections and component libraries. Happy to share case studies.",
    ...
    },
    {
        ...
        taskId: "task-seed-1",
        freelancerId: "f1",
        coverLetter: "Your stack matches my daily toolkit. I can deliver a polished v1 in three weeks with weekly demos.",
    ...
    },
    {
        ...
        taskId: "task-seed-3",
        freelancerId: "f6",
        coverLetter: "Completed two Hydrogen migrations last quarter with measurable CWV improvements. Available to start immediately.",
    ...
    },
    {
        ...
        taskId: "task-seed-4",
        freelancerId: "f5",
        coverLetter: "Built similar editorial AI workflows for a media startup. Strong on guardrails, review flows, and cost controls.",
